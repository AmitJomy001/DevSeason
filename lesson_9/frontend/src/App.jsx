...
const fetchBackendUrl = import.meta.env.VITE_BACKEND_URL || "http://localhost:8000/run";
console.log("Backend URL:", fetchBackendUrl);
/*
  ...
  const handleSubmit = async () => {
    ...
    */
    ...
    try {
      ...
      console.log("fetching from url: ", fetchBackendUrl);
      const { data } = await axios.post(fetchBackendUrl, payload);
